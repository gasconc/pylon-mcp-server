import { z } from 'zod';
import { listCustomFields, getCustomField, createCustomField, updateCustomField, } from '../client/custom-fields.js';
// ─── Zod Schemas ─────────────────────────────────────────────────────────────
...
async function handleToolCall(name, args) {
    switch (name) {
        case 'pylon_list_custom_fields': {
            ...
            const result = await listCustomFields(object_type, cursor ?? null);
...
const customFieldsModule = { tools, handleToolCall };
